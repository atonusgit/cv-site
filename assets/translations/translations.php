...
class Translations {
	...
	public function personal_statement( $lang ) {
		...
		switch ( $lang ) {
			...
			case 'fi':
				return "<p>Olen tekoälyn soveltamiseen erikoistunut teknologia-asiantuntija, jolla on yli 10 vuoden kokemus ohjelmistokehityksestä, automaatiosta ja digitaalisten tuotteiden rakentamisesta. Olen kehittänyt ja johtanut automaatio- ja tekoälyratkaisuja, varmistaen korkean saatavuuden ja toimintavarmuuden kriittisissäkin olosuhteissa. Taustani on luovilla aloilla ja startup-yrittäjyydessä. Olen tunnettu aloitteellisuudestani, syvällisestä asiantuntemuksestani ja vaikuttavien teknologisten ratkaisujen edistämisestä.</p>";
				break;

			default:
				return "<p>I am a technology expert specializing in the application of artificial intelligence, with over 10 years of experience in software development, automation and building digital products. I have developed and led automation and artificial intelligence solutions, ensuring high availability and reliability, even under critical conditions. My background is in creative industries and startup entrepreneurship. I am known for my initiative, deep expertise and promoting impactful technological solutions.</p>";
				break;
